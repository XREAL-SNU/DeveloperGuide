...
public class RaiseEventExample : MonoBehaviourPun {
    ...
    private void Update() {
        // if(Input.GetKey(KeyCode.Space)) ChangeColor();
    ...
    // [SerializeField]
    // private Text _text;
    // public void OnClick_RaiseEvent() {
    //     PhotonNetwork.RaiseEvent(1, "Hello", true, new RaiseEventOptions {
    ...
    //         _text.text = photonEvent.CustomData.ToString();
    //     }
    // }
}
